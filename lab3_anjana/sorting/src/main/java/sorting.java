...
public class sorting {
	...
	public static void main(String[] args) throws Exception {
		...
		String temp = "/lab3/exp1/5m/temp";
		String output = "/lab3/exp1/5m/output"; 
		...
		InputSampler.Sampler<IntWritable, Text> sampler = new InputSampler.RandomSampler<IntWritable, Text>(0.1, 1000, 100);
        ...
        Path pt = new Path("/lab3/exp1/5m/temp/");
